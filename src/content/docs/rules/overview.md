...
A turn measures time in and out of game. The recommendation is that a turn lasts one month of real world time and represents about a month of in-game time. Three turns is a season.

At the start of each turn, players receive letters and two action tokens. On their turn, players can write as many letters as they wish to any regent or steward and spend tokens on [realm actions](/rules/realm-actions).
...
Regents can write letters to any other regent or vassal, whether they're controlled by a player or not. These letters are freeform, there are _no_ rules about what can or cannot be in a letter. You do not even have to send any letters on your turn if you don't want to.
